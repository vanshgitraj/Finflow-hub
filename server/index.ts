...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://finflow.com', 'https://www.finflow.com']
...
app.use('/api/', limiter);
app.use('/api/agents/login', strictLimiter);
app.use('/api/cibil-check', strictLimiter);
...
import { sanitizeInput, securityHeaders } from "./auth";
