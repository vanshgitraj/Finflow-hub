...
// ✅ Match all fields submitted from frontend export const insertLoanApplicationSchema = createInsertSchema(loanApplications).pick({ fullName: true, dateOfBirth: true, mobile: true, email: true, panCard: true, gender: true, currentAddress: true, employmentType: true, monthlyIncome: true, companyName: true, workExperience: true, existingEmis: true, accountType: true, loanType: true, loanAmount: true, tenure: true, purpose: true, });
